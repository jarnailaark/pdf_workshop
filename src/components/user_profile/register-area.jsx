...
import RegisterForm from '@/forms/user-profile-form';
    ...
    return (
        <>
            ...
            <div id="smooth-content">
               <main>
               <div className="signin-banner-area signin-banner-main-wrap d-flex">
                  ...
                  <div className="signin-banner-from d-flex justify-content-center" style={{margin: "6rem"}}>
                     <div className="signin-banner-from-wrap">
                        <div className="signin-banner-title-box">
                           <h4 className="signin-banner-from-title">Profile Detail</h4>
                        </div>
